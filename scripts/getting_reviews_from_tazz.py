        ...
        for restaurant in restaurants:
            ...
            if len(all_reviews) > 0:
                for review in all_reviews:
                    ...
                    print(name, address, review_author, restaurant_categories, minimum_order, delivery_fee, rest_image, city)
            else:
                reviews_info.append({"name" : name, 
                                     "review" : None, 
                                     "review_date" : None,
...
def write_restaurants_info_to_csv(reviews_info):
    with open("C:/Users/Luiza/git/restaurants-unified/media/csvs/tazz.csv", "w", encoding = "utf-8", newline = "") as file:
        headers = ["name", 
                   "review", 
                   "review_date", 
                   "review_rating",                    
