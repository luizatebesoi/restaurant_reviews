...
def change_minimum_order(x):
    ...
    if "RON" in x:
        x = x.replace("RON", "Lei")
    if "Lei" not in x and "Fără" not in x:
        x += " Lei"
    return x
...
def update_data():
    ...
    print("-----------------")
    print("-----------------")
    new_images_downloader(final_restaurants, "../media/csv/final_restaurants_unique_id.csv")
    print("-----------------")
    print("-----------------")
    print("reviews processing")
    print("-----------------")
    print("-----------------")
    final_reviews = final_reviews_processing("../media/csv/tazz.csv", "../media/csv/foodpanda.csv", final_restaurants)
